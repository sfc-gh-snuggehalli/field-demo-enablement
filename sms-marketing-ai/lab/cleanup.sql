...
-- Cascades: schema CORE, all DIM_/FACT_ tables, SMS_DOC_CHUNKS, stage SMS_DOCS,
-- semantic view SMS_MARKETING_SV, Cortex Search service SMS_DOCS_SEARCH, and the
-- agents SMS_MARKETING_AGENT + SMS_MARKETING_AGENT_BASELINE (the latter built in the notebook).
