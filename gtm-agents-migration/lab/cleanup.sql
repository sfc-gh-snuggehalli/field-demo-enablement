...
-- Database cascades: EMAILS/REPS/OUTCOMES/EMAIL_FRAMEWORK/EMAIL_LABELS, the log
-- tables (REQUEST_LOG/ROUTING_LOG/COST_COMPARISON/EVAL_RUNS), EMAIL_GTM_SV,
-- FRAMEWORK_SEARCH, GTM_TEAM_PERFORMANCE, SCORE_EMAIL_INTENT_PROC, the three
...
--
-- -- Logging / eval tables
-- DROP TABLE IF EXISTS DEMO.REQUEST_LOG;
-- DROP TABLE IF EXISTS DEMO.ROUTING_LOG;
-- DROP TABLE IF EXISTS DEMO.COST_COMPARISON;
-- DROP TABLE IF EXISTS DEMO.EVAL_RUNS;
-- DROP TABLE IF EXISTS DEMO.EMAIL_LABELS;
--
-- -- Source data
